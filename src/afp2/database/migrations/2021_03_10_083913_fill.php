...
class Fill extends Migration
{
    ...
    public function up()
    {
        ...
        [
            ...
            'description' => 'A 13-inch student notebook with best-in-class durability and extended battery life so students can learn without limits. 13.3-in. touch display. 8th Generation Intel® Core™ i5-8265U Processor. 8 GB, 1X8 GB 3200MHz DDR4 Non-ECC.', 
            's_description' => 'Dell is among the most renowned PC brands.', 
            'price' => 160000, 
            'category' => 'Notebook',
            'updated_at' => now(),
            'created_at' => now(),
